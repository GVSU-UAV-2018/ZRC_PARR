...
# Generated: Tue Nov 29 19:13:53 2016
##################################################
...
class test_waterfall(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Test Waterfall")
...
def main(top_block_cls=test_waterfall, options=None):
